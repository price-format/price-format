...
var AlertBox = exports.AlertBox = function () {
  function AlertBox() {
  ...
  _createClass(AlertBox, [{
    ...
    value: function saySomething() {
      var speech = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Hello 😊';
...
var _alertBox = __webpack_require__(/*! ./alert-box */ "./src/alert-box.js");

var _ref = new _alertBox.AlertBox(),
    saySomething = _ref.saySomething;
